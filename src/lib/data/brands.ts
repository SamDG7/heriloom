...
const NECTAR_CANDLE_IMG =
  "https://images.unsplash.com/photo-1670967473842-38cf7d288485?auto=format&fit=crop";
    ...
    rewardCatalog: [
      {
        ...
        imageUrl: "/halfwave-crest-burned-reward.png",
      ...
      },
      {
        ...
        imageUrl: "/dropticket-burned-reward.png",
    ...
    rewardCatalog: [
      {
        ...
        imageUrl: "/amber-bloom-reward.png",
  ...
  },
  {
    ...
    rewardCatalog: [
      ...
      },
      {
        ...
        imageUrl: "/hydrate-burned-reward.png",
        shippingNote: "Ships in 3–5 business days.",
      },
    ],
  },
